...
import com.example.nhac.Activity.DanhsachtatcachudeActivity;
import com.example.nhac.Activity.DanhsachtheloaitheochudeActivity;
...
public class Fragment_ChuDe_TheLoai_ToDay extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        txtxemthemchudetheloai = view.findViewById(R.id.textviewtitle);
